...
public class AppointmentPositionalList<E> implements PositionalList<E> {

	AppointmentPositionalList<E> self;
	private class DNode<E> implements Position<E> { 
		private E element; 
		private DNode<E> prev, next;
		AppointmentPositionalList<E> list;
		...
		public DNode(E element, DNode<E> prev, DNode<E> next) {
			...
			this.prev = prev;
			this.next = next;
			this.list = (AppointmentPositionalList<E>) self;
		}
		...
		public AppointmentPositionalList getList(){
			return list;
	...
	public AppointmentPositionalList() {
		this.size = 0;
	...
	private DNode<E> addBetween(DNode<E> b, DNode<E> a, E e) { 
		DNode<E> newNode = new DNode<E>(e, b, a);
		b.setNext(newNode);
		a.setPrev(newNode);
		size++;
		return newNode;
